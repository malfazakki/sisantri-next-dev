  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {['Software Engineering', 'Accounting', 'Talent Acquisition', 'Marketing', 'Infrastructure'].map((dept, i) => (
          <div key={i} className="p-5 bg-white rounded-xl shadow-sm border border-slate-100 hover:border-indigo-200 transition-all group">
