...
import { Plus, Loader2, Trash2, Edit2, Activity as ActivityIcon } from "lucide-react";
						...
						<table className='w-full text-left'>
							<thead>
								<tr className='border-b bg-zinc-50/50 dark:bg-zinc-900/50 transition-colors'>
									<th className='px-6 py-4 font-semibold text-zinc-700 dark:text-zinc-300'>Activity Name</th>
									<th className='px-6 py-4 font-semibold text-zinc-700 dark:text-zinc-300'>Internal ID</th>
									<th className='px-6 py-4 font-semibold text-zinc-700 dark:text-zinc-300'>Created At</th>
									<th className='px-6 py-4 font-semibold text-zinc-700 dark:text-zinc-300 text-right'>Actions</th>
								</tr>
							</thead>
							<tbody className='divide-y divide-zinc-100 dark:divide-zinc-800'>
								{activities?.length === 0 ? (
									<tr>
										<td colSpan={4} className='px-6 py-20 text-center'>
											<div className='flex flex-col items-center gap-3'>
												...
												<div className='flex flex-col gap-1'>
													<p className='text-lg font-medium text-zinc-900 dark:text-zinc-100'>No activities found</p>
													<p className='text-sm text-zinc-500'>Get started by creating your first activity.</p>
												</div>
												<Button 
													variant='outline' 
									...
									activities?.map((activity) => (
										<tr key={activity.id} className='hover:bg-zinc-50/50 dark:hover:bg-zinc-900/50 transition-colors group'>
